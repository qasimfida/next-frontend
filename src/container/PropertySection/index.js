            ...
            <div className="col-lg-4">
              <Form>
                <div className="sidebar_form card card-body  wow fadeInUp">
                  ...
                  <Form.Group className={styles.form_group} controlId="property_from_select_status">
                  ...
                  <Form.Group className={styles.form_group} controlId="property_from_select_type">
                    <Form.Control as="select">
                  ...
                  <Form.Group className={styles.form_group} controlId="property_from_select_rooms">
                    <Form.Control as="select">
                  ...
                  <Form.Group className={styles.form_group} controlId="property_from_select_price">
                    <Form.Control as="select">
                      <option>Price</option>
                      <option>$1000</option>
                      <option>$2000</option>
                    ...
                    <div>
                      <Accordion.Toggle
                        ...
                        <span className={styles.toggle_icon}>
                          <FontAwesomeIcon icon={faAngleDown} color="white" size="xs" />
                        </span>
                      ...
                      <Accordion.Collapse eventKey="0">
                        <div className={styles.checkbox}>
                          <div className="mb-3">
                            <Form.Check type="checkbox" id={`check-api-checkbox-1`}>
                          ...
                          <div className="mb-3">
                            <Form.Check type="checkbox" id={`check-api-checkbox-2`}>
                              <Form.Check.Input type="checkbox" isValid />
                              <Form.Check.Label />
                          ...
                          <div className="mb-3">
                            <Form.Check type="checkbox" id={`check-api-checkbox-3`}>
                              <Form.Check.Input type="checkbox" isValid />
                              <Form.Check.Label />
                          ...
                          <div className="mb-3">
                            <Form.Check type="checkbox" id={`check-api-checkbox-4`}>
                              <Form.Check.Input type="checkbox" isValid />
                              <Form.Check.Label />
                          ...
                          <div className="mb-3">
                            <Form.Check type="checkbox" id={`check-api-checkbox-5`}>
                              <Form.Check.Input type="checkbox" isValid />
                              <Form.Check.Label />
                          ...
                          <div className="mb-3">
                            <Form.Check type="checkbox" id={`check-api-checkbox-6`}>
                              <Form.Check.Input type="checkbox" isValid />
                              <Form.Check.Label />
                          ...
                          <div className="mb-3">
                            <Form.Check type="checkbox" id={`check-api-checkbox-7`}>
                              <Form.Check.Input type="checkbox" isValid />
                              <Form.Check.Label />
                          ...
                          <div className="mb-3">
                            <Form.Check type="checkbox" id={`check-api-checkbox-8`}>
                              <Form.Check.Input type="checkbox" isValid />
                              <Form.Check.Label />
              ...
              <div className="property_details_header_wrapper my-4">
                <div className="property_details_header_inner d-flex justify-content-between align-items-start flex-wrap">
                  <div className="property_details_header_left">
                    <h3 className={styles.property_title}>Luxury Family Home</h3>
                    <p className={styles.property_address}>123 Lorem Ipsum, 45 sit Atlanta</p>
                  </div>
              ...
              <div className="property_details_content_wrapper">
                ...
                <div className="property_content_description">
                  <p className={styles.property_content_desc}>
                    ...
                    ullamcorper libero tincidunt fermentum. Phasellus lobortis felis ac molestie
                    dictum. Morbi at efficitur mauris. Aliquam lobortis massa non metus vehicula, at
                    lacinia orci suscipit. Nulla porta urna id turpis aliquet elementum. Praesent
                    condimentum turpis at neque faucibus feugiat. Aenean in dapibus diam. Fusce sit
                    amet neque ornare, maximus sapien eget, feugiat turpis. Praesent quis urna a
                    metus maximus condimentum quis in purus. Nullam molestie aliquet urna. Nunc a
                    elit congue, gravida turpis sed, laoreet orci.
                  </p>
                  <p className={styles.property_content_desc}>
                    Ut pretium, nunc in bibendum iaculis, neque tellus efficitur lectus, sit amet
                    tincidunt justo nisi at risus. Vestibulum ante est, fermentum in laoreet nec,
                    viverra eu mauris. In condimentum ac mauris a efficitur. Ut fringilla sed mauris
                    eget convallis. Phasellus volutpat mattis tincidunt. Pellentesque non lacus
                    felis. Donec ac sem eu libero consequat congue in vehicula justo. Nulla blandit
                    id tortor non luctus. Donec in odio condimentum, condimentum nisi non, porta
                    nisl. Donec sed consectetur erat, eu imperdiet urna. Praesent eu sapien orci.
                  </p>
                </div>
                <div className="property_content_details">
                  <h4 className={styles.property_content_title}>Property Details</h4>
                  <Row>
                    <Col sm="12" md="6">
                  ...
                  <Col sm={12} md={4}>
                    <div className={styles.property_details_features_item}>
                      <span className={`${styles.icon_outer} mr-2`}>
                        <FontAwesomeIcon className={styles.check_icon} icon={faCheck} />
                      </span>
                      air conditioning
                    </div>
                    <div className={styles.property_details_features_item}>
                  ...
                  <Card>
                    <Accordion.Toggle
                      ...
                      <div className="accordion_header d-flex justify-content-between">
                        <div className={styles.accordion_title}>Ground Floor 497 sq ft</div>
                    ...
                    <Accordion.Collapse eventKey="0">
                      <Card.Body>
                        ...
                        <p className={`${styles.property_content_desc} mb-0 mt-3`}>
                          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum tempus
                          ullamcorper libero tincidunt fermentum. Phasellus lobortis felis ac
                          molestie dictum. Morbi at efficitur mauris. Aliquam lobortis massa non
                          metus vehicula, at lacinia orci suscipit. Nulla porta urna id turpis
                          aliquet elementum.
                        </p>
                      </Card.Body>
                    </Accordion.Collapse>
